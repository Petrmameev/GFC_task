### Этот скрипт копирует данные из Excel в google таблицу, чистит данные и объединяет две таблицы
...
final_df = merged_df[["Подразделение", "Номенклатура", "Выручка", "Конечный остаток"]]
...
new_sheet_name = "Объединенные Данные"
